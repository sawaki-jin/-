        ...
        <div class="nav-buttons">
          <div>
            <div class = "koumoku1">
              ...
              <img src="../images/gurafu.jpg">
                <div class ="nakami">
                グラフ<br>グラフページでは、売上や利益のデータをグラフで視覚的に確認し、分析することができます。</a>
                </div>
            </div>
            <div class = "koumoku2">
              <a href='exp_control/input.php'>
              <img src="../images/sisyutukannri.jpg">
                <div class ="nakami">
                支出管理<br>支出管理ページでは、売上や固定費、人件費の入力を行うことができます。</a>
                </div>
            </div>
            <div class = "koumoku3">
              <a href='sales/product_list.php'>
              <img src="../images/hanbaikanri.jpg">
                <div class ="nakami">
                販売管理<br>販売管理ページでは、在庫の管理や商品一覧を見ることができます。</a>
                </div>
            </div>
            <div class = "koumoku4">
              <a href='contact/contact_reception.php'>
              <img src="../images/renraku.jpeg">
                <div class ="nakami">
                本部連絡<br>本部連絡ページでは、本部への連絡や申請することができます。</a>
                </div>
            </div>
            <div class = "koumoku5">
              ...
              <img src="../images/jinji.jpeg">
                <div class ="nakami">
                人事<br>人事ページでは、従業員一覧を見ることができます。</a>
                </div>
          </div>
      </div>
    </div>
